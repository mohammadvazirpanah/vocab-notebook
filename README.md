...
2. **Accept the collaborator invitation** for this repo (check your GitHub notifications/email).
3. **Create your GitHub token** (this is your "key" for saving to the group):
   ...
   - Repository access: **Only select repositories** → choose `vocab-notebook`
...
- The shared lists live in this repo: [`data/words.json`](data/words.json) and [`data/grammar.json`](data/grammar.json).
  Every sync is a commit, so nothing is ever lost — history is always recoverable.
